    ...
    tasks: {
      weekly: {
        ...
        items: [
          ...
          { name: 'Actividades de community building (rotación)', time: '90 min', desc: 'Una actividad entre semana y otra el fin de semana. Petra y Karen rotan la facilitación.' },
