...
export const people: Person[] = [
  {
    ...
    initial: 'U',
    color: 'uxia',
    summary: 'Ausente · Operativa entre semana redistribuida a Petra y Karen. Los grupos de cenas se gestionan fuera de este roster por ahora.',
    tasks: {
      weekly: {
        total: 'Total semanal: — (ausente; operativa redistribuida a Petra y Karen)',
        items: [],
      },
  ...
  },
  {
    ...
    initial: 'P',
    color: 'petra',
    summary: 'Comunidad, onboardings y operativa entre semana · Guardias de fin de semana',
    tasks: {
      weekly: {
        total: 'Total semanal (suma por ocurrencia): 10h 30min',
        items: [
          { name: 'Vaciar el lavavajillas por la mañana (entre semana)', time: '15 min', desc: 'Vaciar el lavavajillas y limpiar la cocina (fregaderos y basura).', when: 'Lunes a viernes a las 9:00' },
          ...
          { name: 'Enviar foto de la pizarra de bebidas', time: '5 min', desc: 'Hacer una foto legible, borrar la pizarra y enviarla desde la app de suministros.', when: 'Domingo por la tarde', href: 'https://suministros.anceu.com' },
          { name: 'Enviar foto de la pizarra de lavandería', time: '5 min', desc: 'Hacer una foto legible, borrar la pizarra y enviarla desde la app de suministros.', when: 'Domingo por la tarde', href: 'https://suministros.anceu.com' },
      ...
      situational: {
        ...
        items: [
          ...
          { name: 'Recogida de paquetes (tarea compartida)', time: '1h/semana compartida', desc: 'Tarea compartida entre Petra y Karen. Recoger los paquetes cuando lleguen.' },
        ],
      },
    },
  },
  {
    ...
    initial: 'K',
    color: 'karen',
    summary: 'Contenido, fotografía, apoyo en onboardings y operativa de cocina entre semana',
    tasks: {
      weekly: {
        total: 'Total semanal (suma por ocurrencia): 9h 20min',
        items: [
          { name: 'Poner lavavajillas después de comer (entre semana)', time: '15 min', desc: 'Vaciar el lavavajillas, limpiar la cocina (fregaderos y basura) y poner el lavavajillas después de comer.', when: 'Lunes a viernes a las 16:00' },
          { name: 'Poner lavavajillas por la noche (entre semana)', time: '15 min', desc: 'Vaciar el lavavajillas, limpiar la cocina (fregaderos y basura) y poner el lavavajillas.', when: 'Lunes a viernes a las 22:00' },
