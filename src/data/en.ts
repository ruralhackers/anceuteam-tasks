...
export const people: Person[] = [
  {
    ...
    initial: 'P',
    color: 'petra',
    summary: 'Community, onboardings and weekday operations · Weekend duty',
    tasks: {
      weekly: {
        total: 'Weekly total (sum per occurrence): 10h 30min',
        items: [
          { name: 'Empty the dishwasher in the morning (weekdays)', time: '15 min', desc: 'Empty the dishwasher and clean the kitchen (sinks and trash).', when: 'Monday to Friday at 9:00' },
          ...
          { name: 'Send beverage whiteboard photo', time: '5 min', desc: 'Take a readable photo, erase the whiteboard and send it from the supplies app.', when: 'Sunday afternoon', href: 'https://suministros.anceu.com' },
          { name: 'Send laundry whiteboard photo', time: '5 min', desc: 'Take a readable photo, erase the whiteboard and send it from the supplies app.', when: 'Sunday afternoon', href: 'https://suministros.anceu.com' },
      ...
      monthly: { total: '', items: [] },
      situational: {
        total: 'Situational and shared tasks',
        items: [
          ...
          { name: 'Package collection (shared task)', time: '1h/week shared', desc: 'Shared by Petra and Karen. Collect packages when they arrive.' },
        ],
      },
    },
  },
  {
    ...
    initial: 'K',
    color: 'karen',
    summary: 'Content, photography, onboarding support and weekday kitchen operations',
    tasks: {
      weekly: {
        total: 'Weekly total (sum per occurrence): 9h 20min',
        items: [
          { name: 'Run dishwasher after lunch (weekdays)', time: '15 min', desc: 'Empty the dishwasher, clean the kitchen (sinks and trash) and run the dishwasher after lunch.', when: 'Monday to Friday at 16:00' },
          { name: 'Run dishwasher at night (weekdays)', time: '15 min', desc: 'Empty the dishwasher, clean the kitchen (sinks and trash) and run the dishwasher.', when: 'Monday to Friday at 22:00' },
