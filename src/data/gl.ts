...
export const people: Person[] = [
  ...
  },
  {
    ...
    initial: 'P',
    color: 'petra',
    summary: 'Comunidade, onboardings e operativa entre semana · Gardas de fin de semana',
    tasks: {
      weekly: {
        total: 'Total semanal (suma por ocorrencia): 10h 30min',
        items: [
          { name: 'Baleirar o lavalouza pola mañá (entre semana)', time: '15 min', desc: 'Baleirar o lavalouza e limpar a cociña (fregadeiros e lixo).', when: 'Luns a venres ás 9:00' },
      ...
      situational: {
        ...
        items: [
          ...
          { name: 'Recollida de paquetes (tarefa compartida)', time: '1h/sem compartida', desc: 'Tarefa compartida entre Petra e Karen. Recoller os paquetes cando cheguen.' },
        ],
      },
    },
  },
  {
    ...
    initial: 'K',
    color: 'karen',
    summary: 'Contido, fotografía, apoio nos onboardings e operativa de cociña entre semana',
    tasks: {
      weekly: {
        total: 'Total semanal (suma por ocorrencia): 9h 20min',
        items: [
          { name: 'Poñer lavalouza despois de comer (entre semana)', time: '15 min', desc: 'Baleirar o lavalouza, limpar a cociña (fregadeiros e lixo) e poñer o lavalouza despois de comer.', when: 'Luns a venres ás 16:00' },
          { name: 'Poñer lavalouza pola noite (entre semana)', time: '15 min', desc: 'Baleirar o lavalouza, limpar a cociña (fregadeiros e lixo) e poñer o lavalouza.', when: 'Luns a venres ás 22:00' },
